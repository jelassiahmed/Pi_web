...
import logobaazar from "../../assets/img/baazar_logo-removebg-preview.png"
        ...
        <div className="xl:px-20 md:px-10 sm:px-6 px-4 md:py-12 py-9 2xl:mx-auto 2xl:container md:flex items-center justify-center">
          ...
          <div className="bg-white shadow-lg rounded xl:w-1/3 lg:w-5/12 md:w-1/2 w-full lg:px-10 sm:px-6 sm:py-10 px-2 py-6">
            ...
            <p tabIndex={0} className="focus:outline-none text-sm mt-4 font-medium leading-none text-gray-500">
              Dont have account?{" "}
              <a href="/auth/register" className="hover:text-gray-500 focus:text-gray-500 focus:outline-none focus:underline hover:underline text-sm font-medium leading-none text-gray-800 cursor-pointer">
                {" "}
                Sign up here
              </a>
            </p>
            <button
              aria-label="Continue with google" role="button" className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 p-3 border rounded-lg border-gray-700 flex items-center w-full mt-10 hover:bg-gray-100">
            ...
            <button aria-label="Continue with github" role="button" className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 p-3 border rounded-lg border-gray-700 flex items-center w-full mt-4 hover:bg-gray-100">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width={21} height={20}>
                <path fill="#3F51B5" d="M42,37c0,2.762-2.238,5-5,5H11c-2.761,0-5-2.238-5-5V11c0-2.762,2.239-5,5-5h26c2.762,0,5,2.238,5,5V37z" /><path fill="#FFF" d="M34.368,25H31v13h-5V25h-3v-4h3v-2.41c0.002-3.508,1.459-5.59,5.592-5.59H35v4h-2.287C31.104,17,31,17.6,31,18.723V21h4L34.368,25z" /></svg>
              ...
              <FacebookLogin
                ...
                cssClass="text-base font-medium ml-4 text-gray-700"
              />
            </button>
            ...
            <a href="/auth/forgot-password" tabIndex={0} className="flex justify-end focus:outline-none text-sm mt-4 font-medium leading-none text-gray-500">

              Forgot password

            </a>
            <div className="mt-8">
              <button onClick={handleSubmit} role="button" className="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-indigo-700 border rounded hover:bg-indigo-600 py-4 w-full">
                Sign in
              </button>
            </div>
          </div>
          <div className="xl:w-1/3 md:w-1/2 lg:ml-16 ml-8 md:mt-0 mt-6">
            ...
            <div className="flex items-start mt-8">
              ...
              <p className="sm:text-2xl text-xl leading-7 text-gray-600 pl-2.5">
                Let creators create.<br/>
                This is not only our motto, but also the heart of our mission.<br/>

                The bazaar team brought to light a powerful marketplace.<br/>

                Helping creators jump start their business.</p>
            </div>
          </div>
        </div>
      </div>
